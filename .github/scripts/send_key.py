...
RESEND_API_KEY = os.environ["EMAIL_API_KEY"]
...
# Step 4: Send email using Resend SDK
print("📤 Sending email via Resend...")
resend.api_key = RESEND_API_KEY

params = {
    "from": "Goose Team <onboarding@resend.dev>",  # TODO: Replace with your domain email later
    "to": [email],
